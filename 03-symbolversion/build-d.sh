...
gcc -I ./build/include -o ./build/bin/main_d ./main_d.c -L ./build/lib -l bar
...
gcc -I ./build/include -o ./build/bin/main_d ./main_d.c -L ./build/lib -l bar
echo '--- ldd 输出'
ldd ./build/bin/main_d
echo '--- readelf -d 查看 so'
readelf -d ./build/bin/main_d | grep .so
echo '--- readelf -s 查看 函数'
readelf -s ./build/bin/main_d | grep print
echo
...
LD_LIBRARY_PATH=./build/lib ./build/bin/main_d
